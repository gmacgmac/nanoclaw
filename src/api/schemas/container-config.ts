...
export const AdditionalMountSchema = z.object({
  ...
  readonly: z
    .boolean()
    .optional()
    .describe('Whether mount is read-only. Default: true for safety.'),
});
...
export const McpServerSchema = z.object({
  command: z
    .string()
    .describe('Command to spawn the MCP server (e.g. "npx", "node").'),
  args: z
    .array(z.string())
    .optional()
