...
// suffix (see `makeJid` in src/channels/telegram.ts and the live row `tg:123456789` in
// store/messages.db). Dashboard JIDs use `@internal` suffix (see DashboardChannel.ownsJid).
