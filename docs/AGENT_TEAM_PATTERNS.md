...
Database entries (same chat, different triggers):
  ...
  jid: tg:123456789, folder: andy,      trigger: @andy
  jid: tg:123456789, folder: research,  trigger: @research
  jid: tg:123456789, folder: write,     trigger: @write
```
...
3. Register each in the database:
   ...
   VALUES
     ('tg:123456789', 'Andy', 'andy', '@andy', datetime('now'), 0),
     ('tg:123456789', 'Researcher', 'research', '@research', datetime('now'), 0),
     ('tg:123456789', 'Writer', 'write', '@write', datetime('now'), 0);
   ```
